...
class CustomBottomView @JvmOverloads constructor(
    ...
    private var cbnMenuItems: Array<CurvedModel> = arrayOf()
    private lateinit var bottomNavItemViews: Array<NavigationItemView>
    ...
    fun setMenuItems(cbnMenuItems: Array<CurvedModel>, activeIndex: Int = 0) {
    ...
    fun getMenuItems(): Array<CurvedModel> {
        return cbnMenuItems
    }
